...
/**
 * Fallback WebView shell around Auto's web UI (debug / compare).
 * Default launch is the native [MainActivity].
 */
        ...
        webView.webViewClient =
            object : WebViewClient() {
                override fun shouldOverrideUrlLoading(
                    ...
                    val host = HostPrefs.get(this@WebShellActivity)
                    if (host.isNotEmpty()) {
                ...
                override fun onReceivedError(
                    ...
                    if (request?.isForMainFrame == true) {
                        Toast.makeText(this@WebShellActivity, R.string.load_error, Toast.LENGTH_LONG).show()
                    }
                }
            }
            ...
            object : WebChromeClient() {
                override fun onShowFileChooser(
                    ...
                    return try {
                        ...
                        Toast.makeText(this@WebShellActivity, err.message ?: "picker failed", Toast.LENGTH_SHORT).show()
                        false
                    }
                }
            }
