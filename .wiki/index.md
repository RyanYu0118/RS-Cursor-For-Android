...
* [Web](concepts/web.md) - PWA that attaches to a session; shares the chat-box draft with Cursor
...
* [Web](concepts/web.md) - PWA lifecycle, transcript cache, Agents sidebar, shared chat-box draft with Cursor, remembered model per agent, and Home Screen behaviour
